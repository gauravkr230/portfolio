                ...
                <code className="font-mono text-xs md:text-sm lg:text-base leading-relaxed">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-red-300">'Gaurav kumar'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-red-300">'Full Stack Developer'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-red-400">"Code. Build. Scale."</span>
                    </p>
                  </div>
                  <div className="flex gap-4">
